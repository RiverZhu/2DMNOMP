function [omega_k, ghat_k, GLRT, Y_r] = DetectNew_2D(y_matrix, gamma_oversampling)
...
%     Y_spec = bsxfun(@times, Y_spec, exp(-1j * CoarseOmega_mat));
    ...
    a2D_fft_abs2_sub = a2D_fft_abs2(1:gamma_oversampling(1):end,1:gamma_oversampling(2):end);
