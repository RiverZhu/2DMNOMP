...
MNOMP2D(y_matrix, tau, overSamplingRate, R_s, R_c)
...
%   此处显示详细说明
    ...
    while (1)
        ...
        [omega_k, gain_k, GLRT, y_residue_matrix] = DetectNew_2D(y_residue_matrix, overSamplingRate);
...
% gainList.*exp(1j * (ant_idx_Nx(1) * omegaList(:, 1) + ant_idx_My(1) * omegaList(:, 2)))
